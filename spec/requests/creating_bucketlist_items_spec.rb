...
RSpec.describe "Creating a bucketlist item", type: :request do
  ...
  describe "User creates a bucketlist item" do
    ...
    context "When user passes invalid or no parameters
              as part of the request" do
      ...
      it "Doesn't create a bucket list item when an
          invalid parameter is passed in" do
        generate_bucketlists_for(user, 1)
